...
![logo](img/logo.jpg)
Although considered not compatible on Apple M1 (arm64) CPU architecture by Oracle itself, WebLogic server DOES work on ARM-based processor family (remember the "write once, run everywhere" slogan?). 
